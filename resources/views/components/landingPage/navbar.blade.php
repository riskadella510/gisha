<nav id="{{ request()->is('/') ? 'navbar' : 'navbar-login' }}"
    class="border-gray-200 drop-shadow-lg sticky top-0 z-50 transition-all duration-300">
...
>>>>>>> 7dece0e7cff45e63df7afa7096f2267d873674fa
        ...
        <!--<span class="ml-4 text-lg font-bold">GISHA</span>-->
        ...
        <div class="text-black hidden w-full md:block md:w-auto item" id="navbar-default">
            <ul
...
>>>>>>> 7dece0e7cff45e63df7afa7096f2267d873674fa
                ...
                <li>
                    <a href="/edukasi"
                        class="font-Anek font-bold text-[17px] block py-2 hover:text-[#D95639] {{ Request::is('edukasi*') ? 'text-[#D95639]' : '' }}">
                        Edukasi
                    </a>
                </li>
