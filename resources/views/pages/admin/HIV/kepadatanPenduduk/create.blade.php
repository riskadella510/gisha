...
@section('title', 'Create Jumlah Penduduk')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Jumlah Penduduk</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Jumlah Penduduk</li>
            </ol>
        </nav>
